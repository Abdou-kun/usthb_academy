...
<div class="wrapper">
    <div class="card">
        <form action="#" class="d-flex flex-column">
            ...
            <div class="d-flex align-items-center input-field mb-4"> <span class="fas fa-lock p-2"></span> <input type="password" placeholder="Password" required class="form-control" id="pwd"> <button class="btn" onclick=""> <span class="fas fa-eye-slash"></span> </button> </div>
            ...
            <div class="mb-3"> <span class="text-light-white">Don't have an account?</span> <a href="src=' {{ route('dashboard') }}">Sign Up</a> </div>
        </form>
    </div>
</div>
@endsection
