...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ route('examens.index') }}" data-toggle="collapse" data-target="#collapseUtilities"
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Etudiants Table</h1>
                ...
                <div class="container center">
                    ...
                    <button type="button" class="btn btn-primary" onclick="window.location.href='{{ route('etudiant.searchView') }}';">Modifer</button>
                    <button type="button" class="btn btn-danger" onclick="window.location.href='{{ route('etudiant.searchView') }}';">Supprimer</button>
                </div>
